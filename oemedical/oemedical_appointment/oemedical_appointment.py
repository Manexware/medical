...
class OeMedicalAppointment(models.Model):
    ...
    # def create(self):
    #     val_history = {}
    #     ait_obj = self.env['oemedical.appointment.history']
    #
    #     #val_history['appointment_id_history'] = self.id
    #     val_history['name'] = self.env.user.id
    #     val_history['date'] = time.strftime('%Y-%m-%d %H:%M:%S')
    #     val_history['action'] = "--------------------------------  Changed to Create  ------------------------------------\n"
    #     #self.history_ids.create(val_history)
    #     self.env['oemedical.appointment.history'].sudo().create(val_history)
    #     #return super(OeMedicalAppointment, self).create(self)
